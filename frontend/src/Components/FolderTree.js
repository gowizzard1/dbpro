...
class FolderTree extends Component {
  ...
  // static defaultProps = {
    ...
    toggleCheck() {
      this.setState(prevState => ({
        allowCheck: !prevState.allowCheck,
      }));
    }
    render() {
      return (
        <div>
          {this.props.showToolbar && <FolderToolbar toggleAddingNewFile={this.toggleAddingNewFile} addNewFile={filename => {this.addNewFileInSelectedObj(filename)}} deleteObj={this.deleteSeletedObj}  toggleCheck={this.toggleCheck}/>}
          ...
          <div className={styles.folderTree}>
            <TreeNode
              ...
              numOfFiles={this.state.numOfFiles}
